...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    [[self.rootController.tabBar.items objectAtIndex:0] setTitle:@"Dinner"];
    [[self.rootController.tabBar.items objectAtIndex:1] setTitle:@"Drinks"];
    [[self.rootController.tabBar.items objectAtIndex:2] setTitle:@"Dessert"];
    
    //Set the icons of the tabs
    [[self.rootController.tabBar.items objectAtIndex:0] setImage:[UIImage imageNamed:@"dinner.png"]];
    [[self.rootController.tabBar.items objectAtIndex:1] setImage:[UIImage imageNamed:@"drinks.png"]];
    [[self.rootController.tabBar.items objectAtIndex:2] setImage:[UIImage imageNamed:@"dessert.png"]];
