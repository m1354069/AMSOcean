...
@interface DessertViewController : UIViewController <MBProgressHUDDelegate, UITableViewDelegate, UITableViewDataSource, EGORefreshTableHeaderDelegate, UISearchBarDelegate, UISearchDisplayDelegate> {
    UITableView *dessertTable;
    UINib *menuCell;
...
@property (nonatomic, retain) IBOutlet UITableView *dessertTable;
